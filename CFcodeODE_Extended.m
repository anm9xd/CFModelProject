%BMED 6310 Group Project Code 11-20
...
elseif CF == 0
    ...
    Pparm = mean([6.091615, 64.7532]);
    Aparm = mean([2.393149, 15.04461]);
    Mparm = mean([1.075577, 12.75542]);
    Hparm = mean([2431.41, 1713.089]);
    Dparm = 100
    y0 = [Bparm, Pparm, Aparm, Mparm, Hparm, Dparm];
end
